...
export const apiRoutes = {
  ...
  billRun: "/api/v1/Billing/billRun",
  login: "/api/auth/Login",
  Customer: "/api/v1/Customer",
  EditCustomer: "/api/v1/Customer/update",
  ...
  addCustomerConnection: "/api/v1/Connections/addCustomerConnection",
  ...
  getSpareMetersNew: "/api/v1/Customer/getSpareMetersForConnections",
  ...
  processNames: "/api/v1/Process/processes",
  ...
  processesByTypeId: "/api/v1/Process/processesByTypeId?ProcessTypeId=",
  ...
  meterVendorEventsRef: "/api/v1/Meter/meterVendorEventsRef",
  ...
  unassignedDistricts: "/api/v1/District/unassignedDistricts",
  readingRoutes: "/api/v1/District/readingRoutes",
  district: "/api/v1/District",
  districtUpdate: "/api/v1/District/upadte",
  getCustomerMeterHistory: "/api/v1/Customer/getCustomerMeterHistory?CustId=",
  getMeterPhases: "/api/v1/Meter/getMeterPhases",
  addMeterPhase: "/api/v1/Meter/addMeterPhase",
  editMeterPhase: "/api/v1/Meter/editMeterPhase",
  getConnPhases: "/api/v1/Meter/getConnPhases",
  addConnPhase: "/api/v1/Meter/addConnPhase",
  editConnPhase: "/api/v1/Meter/editConnPhase",
};
