...
function GridSide({
  ...
  const [prodMtrsList, setProdMtrsList] = useState([]);
    ...
    <div>
      ...
      <div style={{ display: ctRatio === 0 ? "none" : "block" }}>
        ...
        <MultiSelectTable
          ...
          spliceIndex={"Id"}
          newList={prodMtrsList}
          setNewList={setProdMtrsList}
      ...
      <div style={{ display: prodMtrsList.length === 0 ? "none" : "block" }}>
        <SpaceHorizontal height={10} />
        Selected Meters:
